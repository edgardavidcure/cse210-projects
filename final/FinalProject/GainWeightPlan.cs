public class GainWeightPlan : Plan{
    ...
    public override void MakePlan()
    {
        ...
        SetPlanDescription("A plan that consists of a healthy diet and workout exercises to help you gain weight.");
        Console.WriteLine();
        Console.WriteLine($"Hello! I am glad to help you creating a {GetPlanName()}.");
